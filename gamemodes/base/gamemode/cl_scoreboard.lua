...
local ply = self.Player
			...
			--self.Name:SetText("" .. ply:Nick() .. "      " .. team.GetName( ply:Team() ) .. "  " .. math.floor( ply:GetUTimeTotalTime() / 3600 ) .. "")
			self.Name:SetText("[" .. team.GetName( ply:Team() ) .. "] [" .. math.floor( ply:GetUTimeTotalTime() / 3600 ) .. "] " .. ply:Nick() .. "")
