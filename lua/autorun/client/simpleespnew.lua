-- "lua\\autorun\\client\\simpleespnew.lua"
...
surface.CreateFont("SegoeUIwtflibby", { font = "Segoe UI", size = 16.5, weight = 1000, antialias = false, outline = false })
...
-- changelog 11/19/2021
-- Segoe UI instead of Verdana custom for now
			draw_SimpleText(v:Nick(), "SegoeUIwtflibby", name_pos.x, name_pos.y, team.GetColor(v:Team()), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		end
