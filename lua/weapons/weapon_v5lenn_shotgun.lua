...
SWEP.Primary.Damage = 1 // How much damage the weapon does at its max (NEW VERSION) We need more damage!!!!!!!!!
...
SWEP.Primary.Spread = 10 // The bullet spread. 0.01 = nospread, anything over 1 would be very terrible spread / NERFED /
