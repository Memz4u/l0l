-- "lua\\weapons\\weapon_lenn_minecraftsword.lua"
...
SWEP.Purpose                = "Just play like its minecraft pvp, duh"
SWEP.Instructions            = "Click fast. kill target faster!"
...
SWEP.MissSound = Sound( "ambient/animal/flies2.wav" )
SWEP.WallSound = Sound( "ambient/animal/flies2.wav" )

//PrimaryFire Settings\\ 
SWEP.Primary.Sound = "ambient/voices/citizen_punches2.wav" // Weapon sound effect. i choosed the awp one but it requires CSS
SWEP.Primary.Damage = 1.5 // How much damage the weapon does at its max / NERFED /
...
SWEP.Primary.Automatic = false // Makes it able to be shoot automatically / forever just by holding the attack button
...
SWEP.Primary.Delay = 0.045 // Delay. or how much milliseconds it takes to shoot another bullet after the other bullet was shot. / INCREASED /
...
function SWEP:PrimaryAttack()
	...
	tr.start = self.Owner:GetShootPos()
        -- endpos originally 100
        -- now 300
	tr.endpos = self.Owner:GetShootPos() + ( self.Owner:GetAimVector() *275 )
...
function SWEP:Initialize()
     ...
     self:SetColor(Color(127, 95, 0, 255)) -- Paints world model (r, g, b, r = red g = green b = blue, pick a value from 0 to 255 or use the RGB chart)
end
...
function SWEP:PreDrawViewModel(vm, wep, ply)
	render.SetColorModulation(1, 0, 0) -- RGB, lets say 0, 0, 1 = blue. 0, 1, 0 = green, and 1, 0, 0, = red. its like rgb but say that 1 = 100, therefore you do not just set 0 to 100 on this one, you actually set it to 1, or 0, its your final options.
end
